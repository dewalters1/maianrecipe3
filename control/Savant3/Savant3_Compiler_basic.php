...
* curly braces into PHP commands or Savant3 method calls.  It will
...
* 	{tpl $this->tplname}
* 
* $Id: Savant3_Compiler_basic.php,v 1.13 2005/01/29 14:17:50 pmjones Exp $
* 
...
require_once 'Savant3/Compiler.php';
require_once 'Savant3/Error.php';
require_once 'Savant3/PHPCodeAnalyzer.php';

class Savant3_Compiler_basic extends Savant3_Compiler {
	...
	*/
	...
	function Savant3_Compiler_basic($conf = array())
	{
		parent::Savant3_Compiler($conf);
			...
			*/
			...
			if ($this->strict) {
				...
				if (count($report) > 0) {
					...
					return new Savant3_Error(
						array(
							'code' => Savant3_ERROR_COMPILE_FAIL,
							'text' => $GLOBALS['_Savant3']['error'][Savant3_ERROR_COMPILE_FAIL],
							'info' => $report
						)
					);
				}
