...
* Base filter class.
*/
require_once 'Savant3/Filter.php';
...
* 
* $Id: Savant3_Filter_colorizeCode.php,v 1.1 2004/10/04 01:52:23 pmjones Exp $
* 
* @author Paul M. Jones <pmjones@ciaweb.net>
* 
* @package Savant3
...
class Savant3_Filter_colorizeCode extends Savant3_Filter {
	...
	* php code tags because Savant3 will try to execute that code when the
	* template runs.
	* 
	* @access public
	* 
